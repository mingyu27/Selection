...
public class MenuPossessCardFragment extends Fragment {
    ...
    public MenuPossessCardFragment() {
    ...
    public static MenuPossessCardFragment newInstance(String param1, String param2) {
        MenuPossessCardFragment fragment = new MenuPossessCardFragment();
