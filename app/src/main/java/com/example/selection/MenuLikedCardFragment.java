...
public class MenuLikedCardFragment extends Fragment {
        ...
        if (getArguments() != null) {
            ...
            try{
                ...
                if(tempUser != null){
                    ...
                    likedKookminCardIndexArrayList = functionUser.getLikedKookmin();
                    likedShinhanCardIndexArrayList = functionUser.getLikedShinhan();
                ...
                for (Integer index : likedShinhanCardIndexArrayList) {
                    ...
                    items.add(new MenuLikedCardFragment.Item(cardName, cardImageResourceId, index));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.like_recyclerview); // fragment_menu_possess_card.xml에 정의된 RecyclerView ID를 사용합니다.
        adapter = new MenuLikedCardFragment.LikecardAdapter(requireContext(), items);
