...
public class AddCardSelectCard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.goNextButton.setOnClickListener(view -> {
            ...
            if(companyToEnrollList.isEmpty()){
                startActivity(new Intent(AddCardSelectCard.this, MainActivity.class));
            }
            else {
                startActivity(new Intent(AddCardSelectCard.this, AddCardSelectCard.class).putExtra("CompanyToEnrollList", companyToEnrollList));
            }
        });
